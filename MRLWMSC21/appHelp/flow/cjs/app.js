        ...
        var calendar = this,
            ...
            tableHead = function (collection, fullCollection) {
                ...
                return _.node('thead', _.node('tr', _.group({
                    ...
                    item: function (counter) {
                        return [collection[counter], settings.klass.weekdays, 'scope=col Title="MRLWMSC21® - ' + fullCollection[counter] + '"'];
                    }
                }))); //endreturn
            ...
            createMonthNav = function (next) {
                ...
                return _.node('div', ' ', settings.klass['nav' + (next ? 'Next' : 'Prev')] + (
                    ...
                    }) + ' ' + 'Title="MRLWMSC21® - ' + (next ? settings.labelMonthNext : settings.labelMonthPrev) + '"'); //endreturn
            },
            //createMonthNav
            ...
            createMonthLabel = function (override) {
                ...
                if (settings.selectMonths && override == undefined) {
                    ...
                    }), settings.klass.selectMonth + ' browser-default', (isOpen ? '' : 'disabled') + ' ' + _.ariaAttr({ controls: calendar.$node[0].id + '_table' }) + ' ' + 'Title="MRLWMSC21® - ' + settings.labelMonthSelect + '"');
                }
            ...
            createYearLabel = function (override) {
                ...
                if (numberYears) {
                    ...
                    if (settings.selectYears && override == undefined) {
                        ...
                        }), settings.klass.selectYear + ' browser-default', (isOpen ? '' : 'disabled') + ' ' + _.ariaAttr({ controls: calendar.$node[0].id + '_table' }) + ' ' + 'Title="MRLWMSC21® - ' + settings.labelYearSelect + '"');
                    }
                }
