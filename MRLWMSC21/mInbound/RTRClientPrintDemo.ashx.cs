...
{
    /// <summary>
    /// Summary description for RTRClientPrintDemo
    /// </summary>
    public class RTRClientPrintDemo : IHttpHandler
    {
        ...
        private void ClientPrint(string sid)
        {
            if (WebClientPrint.ProcessPrintJob(System.Web.HttpContext.Current.Request.Url.Query))
            {
                ...
                System.Web.HttpContext.Current.Session.Remove("receivingTallyReport");
