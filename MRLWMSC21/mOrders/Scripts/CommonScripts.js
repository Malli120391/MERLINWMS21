...
function checkSpecialChar(event) {
    ...
    // alert("The Unicode character code is: " + chCode);        chCode == 45 ||
    if (chCode == 62 || chCode == 60 || chCode == 39 || chCode == 37|| chCode == 43 ||  chCode == 64 || chCode == 94 || chCode == 42 || chCode == 96 || chCode == 126 || chCode == 40 || chCode == 33 || chCode == 35 || chCode == 36 || chCode == 38 || chCode == 41)
        return false;
    else
        return true;
}
