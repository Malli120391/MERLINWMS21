<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReworkProcedureReport.aspx.cs" Inherits="MRLWMSC21.mReports.ReworkProcedureReport" %>
        ...
        $(document).ready(function () {
            ...
            $('#<%=txtNCRefNo.ClientID%>').autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: '<%=ResolveUrl("~/mWebServices/FalconWebService.asmx/GetNCRefNoForReworkProcedureReport") %>',
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        <tr>
            <td class="ModuleHeader" style="width: 30px">
                <nobr>Rework Procedure Report</nobr>
            </td>
                ...
                <table border="0" cellpadding="3" cellspacing="1">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <br />
                            <asp:TextBox runat="server" ID="txtkitCode" Width="130" SkinID="txt_Req" Font-Size="14px"></asp:TextBox>
                        ...
                        <td align="left">
                            ...
                            <br />
                            <asp:TextBox runat="server" ID="txtNCRefNo" Width="130" SkinID="txt_Req" Font-Size="14px"></asp:TextBox>
        ...
        <tr>
            <td id="tdRePortParent" align="center" colspan="2" height="400px">
                ...
                <rsweb:ReportViewer ID="rvReworkProcedureReport" runat="server" Visible="false" Width="99.9%" Height="800" CssClass="rptClass" ZoomMode="Percent"
