<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="3PLBillingReport.aspx.cs" Inherits="MRLWMSC21.mReports._3PLStorageBillingReport" %>
        ...
        <tbody>
            <tr class="module_yellow">
               <%--<td class="ModuleHeader fixed-width">
                ...
                <td class="ModuleHeader fixed-width">
                    <%= GetGlobalResourceObject("Resource", "PLBillingReport")%>
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="center" width="100%">
                ...
                <table border="0" cellpadding="3" cellspacing="1" class="fit right">
                    ...
                    <tr>
                        <td align="left">
                         ...
                         <td align="left">
                             <div class="flex">
                                <asp:TextBox runat="server" ID="txtFromDate" required=""></asp:TextBox>
                                  <span class="errorMsg"></span>
                        ...
                        <td align="left">
                           <div class="flex">
                                <asp:TextBox runat="server" ID="txtToDate" required=""></asp:TextBox>
                                  <span class="errorMsg"></span>
                                 <%--<label>To Date</label>--%>
        ...
        <tr>
            <td id="tdRePortParent" align="center" colspan="2" height="600px">
                ...
                <rsweb:ReportViewer ID="rv3BillingReport" runat="server" Visible="false" Width="99.9%" Height="600" CssClass="rptClass" ZoomMode="Percent"
