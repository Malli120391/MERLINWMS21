<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ConsolidatedMaterialIssueReport.aspx.cs" Inherits="MRLWMSC21.mReports.ConsolidatedMaterialIssueReport" %>
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        <tr>
            <td class="ModuleHeader" align="center" width="155px">
                <nobr>Consolidated Material Issue Report</nobr>
            </td>
        ...
        <tr>
            ...
            <td id="tdRePortParent" align="center" colspan="2" height="350px">
                ...
                <rsweb:ReportViewer ID="rvMaterialIssueReport" runat="server" Visible="false" Width="99.9%" Height="800" CssClass="rptClass" ZoomMode="Percent" ShowZoomControl="true"
