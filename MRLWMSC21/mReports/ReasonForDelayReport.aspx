<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReasonForDelayReport.aspx.cs" Inherits="MRLWMSC21.mReports.ReasonForDelayReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            var textfieldname = $('#<%=this.txtJobOrderRefNo.ClientID%>');
            DropdownFunction(textfieldname);
            $("#<%= this.txtJobOrderRefNo.ClientID %>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.d == "") {
                                alert('No Job Orders in the KitCode to received items');
                            }
                            response($.map(data.d, function (item) {
                                return {
                                    label: item.split(',')[0],
...
<div class="pagewidth">
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        <tr>
            <td class="ModuleHeader" style="width: 100px">
                <nobr>Reason For Delay Report</nobr>
            </td>
        ...
        <tr>
            <td id="tdRePortParent" align="center" colspan="2" height="400px">
                ...
                <rsweb:ReportViewer ID="rvReasonForDelay" align="center" runat="server" Visible="false" Width="99.9%" Height="800" CssClass="rptClass" ZoomMode="Percent" ShowZoomControl="true"
