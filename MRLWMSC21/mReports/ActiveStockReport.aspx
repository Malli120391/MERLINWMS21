<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActiveStockReport.aspx.cs" Inherits="MRLWMSC21.mReports.ActiveStockReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            var texfieldname = $('#<%=txtMType.ClientID%>');
            DropdownFunction(texfieldname);
            $('#<%=txtMType.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/mWebServices/FalconWebService.asmx/LoadMTypeDataForReports") %>',
                        data: "{ 'prefix': '" + request.term + "','TenantID':'" +<%= this.cp.TenantID %> +"'}",
                        dataType: "json",
                        type: "POST",
                        async: true,
                ...
                select: function (e, i) {
                    ...
                    $("#<%=this.hifMType.ClientID%>").val(i.item.val);
    ...
    <script>
        $(document).ready(function () {
            var texfieldname = $('#<%=txtLocation.ClientID%>');
            DropdownFunction(texfieldname);
            $('#<%=txtLocation.ClientID%>').autocomplete({
                ...
                select: function (e, i) {
                    ...
                    $("#<%=this.hifLocation.ClientID%>").val(i.item.val);
            ...
            <td class="parmArea" colspan="2" align="right">
                ...
                <table border="0" cellpadding="3" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <label style="font-size: 15px">Material Type : </label>
                            <br />
                            <asp:TextBox runat="server" ID="txtMType" Width="140" SkinID="txt_Req" Font-Size="14px"></asp:TextBox>
                            <asp:HiddenField runat="server" ID="hifMType" />
                        ...
                        <td align="left">
                            ...
                            <br />
                            <asp:TextBox runat="server" ID="txtLocation" Width="140" SkinID="txt_Req" Font-Size="14px"></asp:TextBox>
                            <asp:HiddenField runat="server" ID="hifLocation" />
                      ...
                      <%--  <td align="left">
                            ...
                            <br />
                            <asp:TextBox runat="server" ID="txtSerialNo" Width="125" Font-Size="14px"></asp:TextBox>
                        ...
                        <td align="left">
                            ...
                            <br />
                            <asp:TextBox runat="server" ID="txtBatchNo" Width="125" Font-Size="14px"></asp:TextBox>
                        </td>--%>
