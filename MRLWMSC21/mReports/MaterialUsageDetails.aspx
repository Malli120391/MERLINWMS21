<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaterialUsageDetails.aspx.cs" Inherits="MRLWMSC21.mReports.MaterialUsageDetails" %>
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        <tr>
            <td class="ModuleHeader" style="width: 30px">
                <nobr>Work In Process Report</nobr>
            </td>
        ...
        <tr>
            <td id="tdRePortParent" align="center" colspan="2" height="400px">
                ...
                <rsweb:ReportViewer ID="rvMaterialUsageDetails" Visible="false" runat="server" Width="100%" Height="800" CssClass="rptClass" ZoomMode="Percent"
