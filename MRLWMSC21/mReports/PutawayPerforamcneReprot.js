...
myApp.controller('PickPerformance', function ($scope, $http) {
  ...
  //  }
    ...
    $scope.Getgedetails = function () {
        ...
        var httpreq = {
            method: 'POST',
            url: 'PutawayPerforamcneReprot.aspx/GetBillingReportList',
            headers: {
    ...
    $scope.export = function (TableData) {
        ...
        $("#tbldata").empty();
        $("#tbldata").append("<table><thead><tr><th align='center'>S.No</th><th align='center'>Total Inward Work Lines</th><th>Work Items Completed</th><th>Work Completed Percent</th><th>Work Items Pending</th><th>Work Pending Percent</th></thead><tbody>");
        if (table != null && table.length > 0) {       
        for (var i = 0; i < table.length; i++) {
            $("#tbldata").append("<tr><td class='aligntext'>" + (i + 1) + "</td><td class='aligntext'>" + table[i].TotalInwardWorkLines + "</td><td class='aligntext'>" + table[i].WorkItemsCompleted + "</td><td class='aligntext'>" + table[i].WorkCompletedPercent + "</td><td class='aligntext'>" + table[i].WorkItemsPanding + "</td><td class='aligntext'>" + table[i].WorkPendingPercent + "</td></tr>");
        }
