...
namespace MRLWMSC21.mReports
{
    public partial class CustomerReturns : System.Web.UI.Page
    {
        ...
        {
            rvSUPINVReport.Visible = true;
            rvSUPINVReport.ServerReport.ReportServerUrl = new Uri(CommonLogic.Application("ReportServerUrl"));
            rvSUPINVReport.ServerReport.ReportPath = CommonLogic.Application("ReportPath") + "CustomerReturns";
            ...
            rvSUPINVReport.ServerReport.SetParameters(_reportParameterCollection);
