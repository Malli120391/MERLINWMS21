...
{
    /// <summary>
    /// Summary description for CurrentStockClientPrintDemo
    /// </summary>
    public class CurrentStockClientPrintDemo : IHttpHandler
    {
        ...
        private void ClientPrint(string sid)
        {
            if (WebClientPrint.ProcessPrintJob(System.Web.HttpContext.Current.Request.Url.Query))
            {
                ...
                System.Web.HttpContext.Current.Session.Remove("currentStock");
            }
        }
