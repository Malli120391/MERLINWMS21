<%@ Page Title="Dashboards" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboards.aspx.cs" Inherits="MRLWMSC21.mReports.Dashboards" %>
...
<div class="dashed"></div>
    ...
    <div ng-app="MyApp" ng-controller="Dashboards"><br />
        <div align="right">
         <div class="flex">
        <input type="text" id="txtWareHouse" required="" placeholder="Select Warehouse"/>  
             </div>
            </div>
