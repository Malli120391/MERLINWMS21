<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="OutboundTransactionsHistory.aspx.cs" Inherits="MRLWMSC21.mReports.OutboundTransactionsHistory" %>
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        <tr>
            <td class="ModuleHeader" align="center" width="155px">
                <nobr>Outbound Transactions History</nobr>
            </td>
                ...
                <table border="0" cellpadding="3" cellspacing="1">
                    ...
                    <tr>
                        <%--<td>
                            ...
                            <asp:TextBox runat="server" ID="txtYear" Width="120"  Font-Size="14px"></asp:TextBox>
        ...
        <tr>
            ...
            <td id="tdRePortParent" align="center" colspan="2" height="400px">
                ...
                <rsweb:ReportViewer ID="rvOutboundTransactionsHistory" runat="server" Visible="false" Width="99.9%" Height="800" CssClass="rptClass" ZoomMode="Percent" ShowZoomControl="true"
