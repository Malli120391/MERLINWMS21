<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JRPReport.aspx.cs" Inherits="MRLWMSC21.mReports.JRPReport" %>
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        ...
        <tr>
            <td id="tdRePortParent" align="center" colspan="2" height="400px">
                ...
                <rsweb:ReportViewer ID="rvJRPReport" runat="server" Visible="false" Width="99.9%" Height="800" CssClass="rptClass" ZoomMode="Percent" ShowZoomControl="true"
