<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InspectionCheckList.aspx.cs" Inherits="MRLWMSC21.mReports.InspectionCheckList" %>
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
        <tr>
            <td class="ModuleHeader" style="width: 30px">
                <nobr>Inspection Checklist Report</nobr>
            </td>
        ...
        <tr>
            <td id="tdRePortParent" align="center" colspan="2" height="400px">
                ...
                <rsweb:ReportViewer ID="rvICLReport" runat="server" Visible="false" Width="99.9%" Height="800" CssClass="rptClass" ZoomMode="Percent"
