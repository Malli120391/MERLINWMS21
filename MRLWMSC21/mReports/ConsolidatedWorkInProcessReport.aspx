<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsolidatedWorkInProcessReport.aspx.cs" Inherits="MRLWMSC21.mReports.ConsolidatedWorkInProcessReport" %>
   ...
   <!-- <script>
        $(document).ready(function () {
            ...
            $("#<%= this.txtJobOrderRefNo.ClientID %>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/mWebServices/FalconWebService.asmx/LoadPRONumberforCoC") %>',
    ...
    <table border="0" cellpadding="2" cellspacing="0" align="left"  width="100%" >
        <tr>
            <td class="ModuleHeader" style="width:30px"><nobr>Consolidated Work In Process Report</nobr></td>
            <td class="parmArea" colspan="2"  align="right"> 
               ...
               <tr>
                  <!--   <td align="left">
                        <label style="font-size:15px"> Kit Code : </label> <br />
       ...
       <!-- <td   align="left" class="FormLabels" colspan="4" >
        ...
        <td id="tdRePortParent"  align="center" colspan="2" Height="400px">
            ...
            <rsweb:ReportViewer ID="rvConsolidatedWorkInProcessReport" Visible="false"  runat="server" Width="99.9%" Height="800" CssClass="rptClass"  ZoomMode="Percent" 
