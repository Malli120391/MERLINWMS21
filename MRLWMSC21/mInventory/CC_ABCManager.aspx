<%@ Page Title="Cycle Count" Language="C#" MasterPageFile="~/mInventory/InventoryMaster.master"  AutoEventWireup="true" CodeBehind="CC_ABCManager.aspx.cs" Inherits=" MRLWMSC21.mInventory.CC_ABCManager" EnableEventValidation="false" %>
   ...
   <script type="text/javascript">
       ...
       function openDialogAndBlock(title, linkID)
       {
           if (title == 'Add Cycle Count')
           {
               ...
               var Class = $("#<%=ddlCycleClass.ClientID%>").attr("value");
               if (Class == 0) {
                   showStickyToast(false, "Please select 'Cycle Class'");
                   return false;
               }
...
<div class="pagewidth">
              ...
              <div class="ui-dailog-body" style="height:592px">
                ...
                <tr>
                   <%-- <td> <img src="../Images/RT_Logo_icon.jpg" border="0" class="OnlyForPrint"  /></td>--%>
                     <td> <img src="../Images/Logo_Header_falcon.jpg" border="0" class="OnlyForPrint"  /></td>
             ...
             <Columns>
              ...
              <div class="ui-dailog-footer">
                            <div style="padding: 15px 13px 15px 5px;">
                                ...
                                <a id="lnkCloseCCPrint" Class="btn btn-primary" onclick="closePrintCCListDialog()" >Close<%=MRLWMSC21Common.CommonLogic.btnfaClear %></a>
                                <a ID="lnkWorkOrederReport" onclick="printDiv('divPrintListcontainer');" Class="btn btn-primary">Print<%=MRLWMSC21Common.CommonLogic.btnfaPrint %></a>
                                <%--<asp:LinkButton ID="lnkCloseCCPrint" runat="server" CssClass="btn btn-primary" OnClick="lnkCloseCCPrint_Click" > Close<%=MRLWMSC21Common.CommonLogic.btnfaClear %></asp:LinkButton>--%>
                                <%--<asp:LinkButton ID="lnkWorkOrederReport" OnClientClick="printDiv('divPrintListcontainer');" CssClass="btn btn-primary NoPrint" runat="server">
   ...
   <div id="divEditCCDlgContainer">  
	 	...
	 	<asp:GridView ShowFooter="true" GridLines="None" CellPadding="1" CellSpacing="1" ID="gvCCMatList" runat="server" PagerStyle-HorizontalAlign="Right" PagerSettings-Position="TopAndBottom" AutoGenerateColumns="False" AllowPaging="true" PageSize="30" AllowSorting="True" SkinID="gvLightGreenNew" HorizontalAlign="Left"   OnSorting="gvCCMatList_Sorting" OnPageIndexChanging="gvCCMatList_PageIndexChanging" OnRowDataBound="gvCCMatList_RowDataBound" Width="100%" >
            ...
            <asp:TemplateField ItemStyle-Width="80" HeaderText="Part Number" HeaderStyle-HorizontalAlign="Left" SortExpression="MCode" ItemStyle-CssClass="home">
                <ItemTemplate>
          ...
          <div class="ui-dailog-footer">
              <div style="padding: 15px 13px 15px 5px;">
                  <a id="lnkCancleCCWithMMLis" class="btn btn-primary" onclick="closeDialog();">Close<%=MRLWMSC21Common.CommonLogic.btnfaClear %></a>
                    <!--OnClick="lnkCancleCCWithMMLis_Click"-->
                  

                   <asp:LinkButton ID="lnkSaveCCWithMMList" runat="server" CssClass="btn btn-primary" OnClick="lnkSaveCCWithMMList_Click" ValidationGroup="CCCreation" > 
        ...
        <tbody>
            <tr class="module_yellow">
               <td class="ModuleHeader fixed-width">
                          ...
                          <div class="FormSubHeading" style="font-size: larger">ABC -Cycle Count Manager</div>
...
<tr><td> <br /><span class="SubHeading">   </span>  </td>
</tr>
    <tr>
    <td>
...
<table style="width: 540px;height: 48px;float: right;">
<tr>
<td  valign="bottom">
    <div class="flex">
          <asp:RequiredFieldValidator ID="rfvddlWarehouse" SetFocusOnError="true" ControlToValidate="ddlWarehouse" InitialValue="0" Display="Dynamic" EnableClientScript="true"  CssClass="ErrorAlert2" ErrorMessage=" * " runat="server" ValidationGroup="GetCCData"/>
          <asp:DropDownList ID="ddlWarehouse" runat="server" CssClass="ddl_slim"  required="" />
 ...
 <td  valign="bottom">
        <asp:RequiredFieldValidator ID="rfvddlCycleClass" SetFocusOnError="true" ControlToValidate="ddlCycleClass" InitialValue="0" Display="Dynamic" EnableClientScript="true"  CssClass="ErrorAlert2" ErrorMessage=" * " runat="server" ValidationGroup="GetCCData"/> 
     <!-- <a class="helpWTitle" Title="Cycle Class| Cycle Class are categories of items segregated in terms of warehouse movement as shown in the following table.</a><br/><br/>
      <table border='1' style='background-color:#EFEFEF' cellpadding='1' cellspacing='1' align='center' width='100%'><tr><td>Cycle Class</td><td> Description </td><td> Movement</td></tr>
      <tr><td align='center'>A</td><td>Fast Movers</td><td align='center'> > 80% </td></tr>
      <tr><td align='center'>B</td><td>Medium Movers</td><td align='center'> 60% to 80% </td></tr>
      <tr><td align='center'>C</td><td>Slow Movers</td><td align='center'> 30% to 60% </td></tr>
      <tr><td align='center'>D</td><td>Dead Stock</td><td align='center'> < 30% </td></tr>
      </table> ">-->
      
      <!--<img src="Images/help_icon.gif" border="0" />-->
         
      <div class="flex">
           <asp:DropDownList ID="ddlCycleClass" runat="server" CssClass="ddl_slim" required="" />
           <label>Cycle Class</label>
          <span class="errorMsg"></span>
          </div>
     </td>
     
 <td class="auto-style1" valign="bottom">
 <asp:LinkButton ID="lnkGetCycleClassData" runat="server" OnClick="lnkGetCycleClassData_Click" CssClass="btn btn-primary right" ValidationGroup="GetCCData" >
	 ...
	 <table cellpadding="0" cellspacing="0" border="0" width="95%" >
												...
												<asp:LinkButton runat="server" ID="lnkAddNewCC" CssClass="btn btn-primary right right22" OnClick="lnkAddNewCC_Click" >Add Cycle Count<%=MRLWMSC21Common.CommonLogic.btnfaNew %></asp:LinkButton>
	  ...
	  <asp:GridView Width="100%" ShowFooter="true" GridLines="None"  CellPadding="1" CellSpacing="1" ID="gvCycleCountManager" runat="server" PagerStyle-HorizontalAlign="Right" PagerSettings-Position="TopAndBottom" AutoGenerateColumns="False" AllowPaging="true" PageSize="25" AllowSorting="True" CssClass="overallGrid table-striped" HorizontalAlign="Left"   OnSorting="gvCycleCountManager_Sorting" OnPageIndexChanging="gvCycleCountManager_PageIndexChanging" OnRowDataBound="gvCycleCountManager_RowDataBound" OnRowCommand="gvCycleCountManager_RowCommand" >
            <Columns>
...
<asp:AsyncPostBackTrigger ControlID="gvCCABC"></asp:AsyncPostBackTrigger>
	   ...
	   <table cellpadding="0" cellspacing="0" border="0" width="95%" >
												<tr>
                                                    ...
                                                    <div id="divCCRecordCount" runat="server"></div>
													 <asp:Panel ID= "pnlCCSearch" runat="server" CssClass="SearchPanel"  HorizontalAlign="right"   DefaultButton="lnkCCItemSearch">
                                                            <div class="flex__ right right22"> <div class="flex">
    										                 <asp:TextBox ID="txtMCode" CssClass="txt_slim_small" runat="server"  required=""/>
                                                             <label>Part Number</label></div> &nbsp;&nbsp;&nbsp;
    	 ...
    	 <asp:GridView Width="100%" ShowFooter="true" GridLines="None" CellPadding="1" CellSpacing="1"  ID="gvCCABC" runat="server" PagerStyle-HorizontalAlign="Right" PagerSettings-Position="TopAndBottom" AutoGenerateColumns="False" AllowPaging="true" PageSize="30" AllowSorting="True" CssClass="overallGrid table-striped" HorizontalAlign="Left"   OnSorting="gvCCABC_Sorting" OnPageIndexChanging="gvCCABC_PageIndexChanging" OnRowDataBound="gvCCABC_RowDataBound" >
            <Columns>
            ...
            <asp:TemplateField ItemStyle-Width="40" HeaderText="S.No." HeaderStyle-HorizontalAlign="Left"  ItemStyle-CssClass="home">
              ...
              <asp:TemplateField ItemStyle-Width="140" HeaderText="Part Number" HeaderStyle-HorizontalAlign="Left" SortExpression="MCode" ItemStyle-CssClass="home">
                <ItemTemplate>
                <asp:Literal runat="server"  ID="ltMCode" Text='<%# DataBinder.Eval(Container.DataItem, "MCode") %>'/> &nbsp;&nbsp;
                </ItemTemplate>
             </asp:TemplateField>  
             
              <asp:TemplateField ItemStyle-Width="50" HeaderText="No.of Movements" HeaderStyle-HorizontalAlign="Left"  ItemStyle-CssClass="home">
                <ItemTemplate>
    ...
    <asp:GridView Width="100%" ShowHeaderWhenEmpty="true" CellPadding="5" ShowFooter="false" GridLines="Both"   ID="gvCCreport" runat="server" PagerStyle-HorizontalAlign="Right" PagerSettings-Position="TopAndBottom" AutoGenerateColumns="False" AllowPaging="false"  AllowSorting="True" HorizontalAlign="Left" OnRowDataBound="gvCCreport_RowDataBound">
          <Columns>  
                ...
                <asp:Literal ID="ltUOM"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "BUoM") %>' />
                            ...
                            <asp:Literal ID="ltQty" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "BUoMQty") %>' />    <br />
                </ItemTemplate>
             </asp:TemplateField>
              <asp:TemplateField HeaderText="Location" ItemStyle-HorizontalAlign="Left">         
                <ItemTemplate>
