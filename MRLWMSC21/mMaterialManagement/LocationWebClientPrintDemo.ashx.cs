...
{
    /// <summary>
    /// Summary description for LocationWebClientPrintDemo
    /// </summary>
    public class LocationWebClientPrintDemo : IHttpHandler
    {
        ...
        private void ClientPrint(string sid)
        {
            if (WebClientPrint.ProcessPrintJob(System.Web.HttpContext.Current.Request.Url.Query))
            {
                ...
                System.Web.HttpContext.Current.Session.Remove("locationManager");
