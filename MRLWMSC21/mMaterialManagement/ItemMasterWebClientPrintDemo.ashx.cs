...
{
    /// <summary>
    /// Summary description for ItemMasterWebClientPrintDemo
    /// </summary>
    public class ItemMasterWebClientPrintDemo : IHttpHandler
    {
        ...
        private void ClientPrint(string sid)
        {
            if (WebClientPrint.ProcessPrintJob(System.Web.HttpContext.Current.Request.Url.Query))
            {
                ...
                System.Web.HttpContext.Current.Session.Remove("itemMaster");
