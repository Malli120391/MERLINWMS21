...
{
    /// <summary>
    /// Summary description for ContainerWebClientPrintDemo
    /// </summary>
    public class ContainerWebClientPrintDemo : IHttpHandler
    {
        ...
        private void ClientPrint(string sid)
        {
            if (WebClientPrint.ProcessPrintJob(System.Web.HttpContext.Current.Request.Url.Query))
            {
                ...
                System.Web.HttpContext.Current.Session.Remove("containerManagement");
