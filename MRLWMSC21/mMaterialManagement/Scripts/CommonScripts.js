...
function Addressset(event) {

    var chCode = ('charCode' in event) ? event.charCode : event.keyCode;
    // alert("The Unicode character code is: " + chCode);
    if (chCode == 60 || chCode == 62 || chCode == 39 || chCode == 34)
        return false;
    else
        return true;
}
...
function Phoneset(event) {
    ...
    if (chCode >= 48 && chCode <= 57 || chCode == 32 || chCode == 43 || chCode == 41 || chCode == 41)
        return true;
    else
        return false;
}
...
function Emailset(event) {
    ...
    var chCode = ('charCode' in event) ? event.charCode : event.keyCode;
    // alert("The Unicode character code is: " + chCode);
    if ((chCode >= 65 && chCode <= 122 && chCode && !(chCode > 90 && chCode < 97)) || chCode >= 48 && chCode <= 57 || chCode == 64 || chCode == 46 || chCode == 95 || chCode == 0)
        return true;
    else
        return false;
}
