...
{
    /// <summary>
    /// Summary description for ContainerWebClientPrint
    /// </summary>
    public class ContainerWebClientPrint : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                else if (prType == RequestType.ClientSetInstalledPrinters)
                {
                    ...
                    context.Application.Set(context.Request.UserHostName+"_"+sessionID + "printers", printers);
                    //if(printers!=null & sessionID!=null)
                    //{
                      
                    //    context.Session.Add(sessionID + "printers", printers);
                ...
                else if (prType == RequestType.ClientGetInstalledPrinters)
                {
                    ...
                    bool sidHasPrinters = (context.Application[context.Request.UserHostName + "_" + sessionID + "printers"] != null);

                    context.Response.ContentType = "text/plain";
                    //context.Response.Write(sidHasPrinters ? context.Application[sessionID + "printers"] : "");
                    context.Response.Write(sidHasPrinters ? context.Application[context.Request.UserHostName + "_"+sessionID + "printers"] : "");
