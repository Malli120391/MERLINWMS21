...
namespace MRLWMSC21.mMaterialManagement
{
    public partial class DisplayPDF : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String TenantID = CommonLogic.QueryString("tid");  
            String mid = CommonLogic.QueryString("mid");
            String sid = CommonLogic.QueryString("sid");
            ...
            try
            {
                ...
                if (filename != null || filename != "")
                {
                    ...
                    path = path + TenantRootDir + TenantID + MMTPath + mid + "/" + sid + "/";
                    //path = path + TenantRootDir + MMTPath + mid + "/" + sid + "/";
                    path += "/" + filename;
