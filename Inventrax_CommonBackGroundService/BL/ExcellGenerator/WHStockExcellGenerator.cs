...
{
    public class WHStockExcellGenerator : IExcellGenerator
    {
        public void Create(DataTable dt, string tenantName, string warehouseName, string fileName)
        {
            try
            {
                ...
                ExcelWorksheet objWorksheet = objExcelPackage.Workbook.Worksheets.Add("WarehouseStock");
                ...
                objWorksheet.Cells[1, 1, 2, val].RichText.Text = "Warehouse Stock summary Report from Shipper";
                #endregion
            ...
            {
                // LogWriter.WriteLog("Exception in method ExcellExport.ExportExcelDataForReports()  " + ex.Message);
            }
        }
    }
}
