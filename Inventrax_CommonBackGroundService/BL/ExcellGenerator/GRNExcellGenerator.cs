...
{
    public class GRNExcellGenerator : IExcellGenerator
    {
       public  void Create(DataTable dt, string tenantName, string warehouseName, string fileName)
       {
            try
            {
                ...
                ExcelWorksheet objWorksheet = objExcelPackage.Workbook.Worksheets.Add("GRN");
                ...
                objWorksheet.Cells[1, 1, 2, val].RichText.Text = "Notification (GRN) from Shipper";
                #endregion
