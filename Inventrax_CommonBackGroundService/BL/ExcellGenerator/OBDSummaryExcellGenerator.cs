...
{
    public class OBDSummaryExcellGenerator : IExcellGenerator
    {
        public void Create(DataTable dt, string tenantName, string warehouseName, string fileName)
        {
            try
            {
                ...
                ExcelWorksheet objWorksheet = objExcelPackage.Workbook.Worksheets.Add("OBDSummary");
                ...
                objWorksheet.Cells[1, 1, 2, val].RichText.Text = "OBD Summary Report from Shipper";
                #endregion
